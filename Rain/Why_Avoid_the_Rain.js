...
class StartController extends Component{
    ...
    update() {
        ...
        if (keysDown["s"] && this.freezeTime >= this.maxFreezeTime){
...
class MainController extends Component {
    ...
    start(ctx) {
        ...
        playerGameObject.addComponent(playerComponent, this.handle)
        ...
        this.enemyGameObject.addComponent(this.enemyComponent, this.handle)
...
// class RainComponent extends Component{
//     start(){
...
//         if (this.addition < 30 && this.addition % 10){
//             if (i != this.offset){
//                 let rainGameObject = new GameObject("Rain" + i)
//                 let rainComponent = new EnemyComponent()
//                 rainComponent.addListener(this)
//                 rainComponent.addListener(GameObject.getObjectByName("Rain1"))
//                 rainGameObject.addComponent(rainComponent)
//                 //create the ball. Need to figure out how to assign which ball is player and which is enemy 
//                 let rainDrop = new Circle() 
//                 rainGameObject.addComponent(rainDrop)
//                 rainDrop.fillStyle = "red"
                
//                 rainDrop.transform.sx = 5
//                 rainDrop.transform.x = 30 * i
//                 GameObject.instantiate(rainGameObject)

//                 rainGameObject = new GameObject("Rain" + -i)
//                 rainComponent = new EnemyComponent()
//                 rainComponent.addListener(this)
//                 rainComponent.addListener(GameObject.getObjectByName("Rain1"))
//                 rainGameObject.addComponent(rainComponent)
//                 //create the ball. Need to figure out how to assign which ball is player and which is enemy 
...
//                 rainGameObject.addComponent(rainComponent)
//                 //create the ball. Need to figure out how to assign which ball is player and which is enemy 
//                 rainGameObject.layers = -1
//                 let rainDrop = new Circle() 
//                 rainGameObject.addComponent(rainDrop)
//                 rainDrop.fillStyle = "green"
